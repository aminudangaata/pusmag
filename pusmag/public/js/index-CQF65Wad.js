(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();const ue="modulepreload",me=function(s){return"/assets/pusmag/"+s},X={},Z=function(e,t,o){let a=Promise.resolve();if(t&&t.length>0){let d=function(u){return Promise.all(u.map(h=>Promise.resolve(h).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};var n=d;document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),i=l?.nonce||l?.getAttribute("nonce");a=d(t.map(u=>{if(u=me(u),u in X)return;X[u]=!0;const h=u.endsWith(".css"),p=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${p}`))return;const g=document.createElement("link");if(g.rel=h?"stylesheet":ue,h||(g.as="script"),g.crossOrigin="",g.href=u,i&&g.setAttribute("nonce",i),document.head.appendChild(g),h)return new Promise((w,b)=>{g.addEventListener("load",w),g.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(l){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=l,window.dispatchEvent(i),!i.defaultPrevented)throw l}return a.then(l=>{for(const i of l||[])i.status==="rejected"&&r(i.reason);return e().catch(r)})},pe=window.location.origin;class ge{constructor(e){this.baseURL=e,this.csrfToken=null}async request(e,t={}){const o=e.startsWith("http"),a=o?e:`${this.baseURL}/api/method/${e}`,r=o?{}:{"Content-Type":"application/json",Accept:"application/json"};if(!o&&t.method==="POST"){r["Content-Type"]="application/json";const l=this.getCSRFToken();l&&(r["X-Frappe-CSRF-Token"]=l)}const n={headers:r,credentials:o?"omit":"include",...t};try{const l=await fetch(a,n);if(!l.ok){let d=`HTTP error! status: ${l.status}`;try{const u=await l.json();if(u.exception)u.exception.includes("AuthenticationError")?d="Invalid email or password. Please try again.":d=u.exception.split(":").pop().trim();else if(u._server_messages){const h=JSON.parse(u._server_messages);d=JSON.parse(h[0]).message}}catch{l.status===401&&(d="Invalid email or password. Please try again.")}throw new Error(d)}const i=await l.json();return i.message?i.message:i}catch(l){throw console.error("API request failed:",l),l}}async get(e,t={}){const o=new URLSearchParams(t).toString(),a=o?`${e}?${o}`:e;return this.request(a,{method:"GET"})}async post(e,t={}){return this.request(e,{method:"POST",body:JSON.stringify(t)})}async getHomepageSlides(){return this.get("pusmag.my_scripts.pusmag.get_homepage_slides")}async getServices(){return this.get("pusmag.my_scripts.pusmag.get_services")}async getStatistics(){return this.get("pusmag.my_scripts.pusmag.get_statistics")}async getVerseOfTheDay(){try{this._surahsCache||(this._surahsCache=await this.request("https://quranapi.pages.dev/api/surah.json"));const e=this._surahsCache;if(!Array.isArray(e)||e.length===0)return null;const t=new Date,o=t.getFullYear()*1e4+(t.getMonth()+1)*100+t.getDate(),a=o%e.length,r=e[a],n=a+1,l=(o*31+n)%r.totalAyah+1;return await this.request(`https://quranapi.pages.dev/api/${n}/${l}.json`)}catch(e){return console.error("Quran API failed:",e),null}}async getEvents(e={}){return this.get("pusmag.my_scripts.pusmag.get_events",{filters:JSON.stringify(e)})}async getEventDetails(e){return this.get("pusmag.my_scripts.pusmag.get_event_details",{event_id:e})}async getBlogPosts(e={}){const{category:t,search:o,limit:a,offset:r}=e;return this.get("pusmag.my_scripts.pusmag.get_blog_posts",{filters:JSON.stringify({category:t,search:o}),limit:a,offset:r})}async getBlogPost(e){return this.get("pusmag.my_scripts.pusmag.get_blog_post",{post_id:e})}async getBlogCategories(){return this.get("pusmag.my_scripts.pusmag.get_blog_categories")}async getGalleryImages(e={}){return this.get("pusmag.my_scripts.pusmag.get_gallery_images",{filters:JSON.stringify(e)})}async getGalleryCategories(){return this.get("pusmag.my_scripts.pusmag.get_gallery_categories")}async submitContactForm(e){return this.post("pusmag.my_scripts.pusmag.submit_contact_form",e)}async getContactInfo(){return this.get("pusmag.my_scripts.pusmag.get_contact_info")}async submitRegistration(e){return this.post("pusmag.my_scripts.pusmag.submit_registration",e)}async login(e,t){return this.post("login",{usr:e,pwd:t})}async logout(){return this.post("logout")}async send2FACode(e){return this.post("pusmag.my_scripts.pusmag_portal.send_2fa_code",{email:e})}async verify2FACode(e,t){return this.post("pusmag.my_scripts.pusmag_portal.verify_2fa_code",{email:e,code:t})}async resetPassword(e){return this.post("pusmag.my_scripts.pusmag_portal.reset_password",{email:e})}async getCurrentUser(){return this.get("frappe.auth.get_logged_user")}async getUserInfo(){const e=await this.get("pusmag.my_scripts.pusmag_portal.get_user_info");return e&&e.csrf_token&&(this.csrfToken=e.csrf_token,window.csrf_token=e.csrf_token),e}async getPortalStats(){return this.get("pusmag.my_scripts.pusmag_portal.get_portal_stats")}async getMemberDirectory(e={}){const{limit:t,offset:o,...a}=e;return this.get("pusmag.my_scripts.pusmag_portal.get_member_directory",{filters:JSON.stringify(a),limit:t,offset:o})}async getPendingRegistrations(){return this.get("pusmag.my_scripts.pusmag_portal.get_pending_registrations")}async approveRegistration(e){return this.post("pusmag.pusmag.doctype.ps_member_registration.ps_member_registration.approve_registration",{registration_name:e})}async rejectRegistration(e,t){return this.post("pusmag.pusmag.doctype.ps_member_registration.ps_member_registration.reject_registration",{registration_name:e,reason:t})}async getUserBlogPosts(e=""){return this.get("pusmag.my_scripts.pusmag_portal.get_user_blog_posts",{search:e})}async getBlogPostDetails(e){return this.get("pusmag.my_scripts.pusmag_portal.get_blog_post_details",{post_id:e})}async saveBlogPost(e){return this.post("pusmag.my_scripts.pusmag_portal.save_blog_post",{post_data:e})}async deleteBlogPost(e){return this.post("pusmag.my_scripts.pusmag_portal.delete_blog_post",{name:e})}async cancelDeleteRequest(e){return this.post("pusmag.my_scripts.pusmag_portal.cancel_delete_request",{name:e})}async publishBlogPost(e,t=null,o=null){return this.post("pusmag.my_scripts.pusmag_portal.publish_blog_post",{name:e,verified:t,published:o})}async requestContactAccess(e){return this.post("pusmag.my_scripts.pusmag_portal.request_contact_access",{member_name:e})}async getContactAccessRequests(){return this.get("pusmag.my_scripts.pusmag_portal.get_contact_access_requests")}async respondToContactRequest(e,t,o=""){return this.post("pusmag.my_scripts.pusmag_portal.respond_to_contact_request",{request_name:e,action:t,reason:o})}async getMemberDetails(e){return this.get("pusmag.my_scripts.pusmag_portal.get_member_details",{member_name:e})}async getPortalProgrammes(){return this.get("pusmag.my_scripts.pusmag_portal.get_portal_programmes")}async saveProgramme(e){return this.post("pusmag.my_scripts.pusmag_portal.save_programme",{programme_data:e})}async deleteProgramme(e){return this.post("pusmag.my_scripts.pusmag_portal.delete_programme",{name:e})}async getPortalGallery(){return this.get("pusmag.my_scripts.pusmag_portal.get_portal_gallery")}async saveGalleryImage(e){return this.post("pusmag.my_scripts.pusmag_portal.save_gallery_image",{image_data:e})}async deleteGalleryImage(e){return this.post("pusmag.my_scripts.pusmag_portal.delete_gallery_image",{name:e})}async uploadFile(e){const t=new FormData;t.append("file",e,e.name),t.append("file_name",e.name),t.append("from_form","1"),t.append("is_private","0"),t.append("folder","Home/Attachments");const o=`${this.baseURL}/api/method/upload_file`,a=await fetch(o,{method:"POST",headers:{"X-Frappe-CSRF-Token":this.getCSRFToken()||""},body:t,credentials:"include"});if(!a.ok){let n="File upload failed";try{const l=await a.json();if(l._server_messages){const i=JSON.parse(l._server_messages);n=JSON.parse(i[0]).message}else l.message&&(n=l.message)}catch{n=`Upload failed with status: ${a.status}`}throw new Error(n)}const r=await a.json();if(r.message&&r.message.file_url)return r.message.file_url;throw new Error("File upload failed: No file URL returned")}getCSRFToken(){if(this.csrfToken)return this.csrfToken;if(window.csrf_token&&window.csrf_token!=="{{ csrf_token }}")return window.csrf_token;const e=document.cookie.split("; ").find(o=>o.startsWith("frappe_csrftoken="));if(e)return e.split("=")[1];const t=document.querySelector('meta[name="csrf-token"]');return t?t.getAttribute("content"):null}}const c=new ge(pe),ee=Object.freeze(Object.defineProperty({__proto__:null,api:c},Symbol.toStringTag,{value:"Module"}));function B(){const s={threshold:.1,rootMargin:"0px 0px -50px 0px"},e=new IntersectionObserver(t=>{t.forEach(o=>{if(o.isIntersecting&&(o.target.classList.contains("animate-on-scroll")&&o.target.classList.add("animate"),o.target.classList.contains("counter"))){const a=parseInt(o.target.dataset.target||0);he(o.target,a),e.unobserve(o.target)}})},s);document.querySelectorAll(".animate-on-scroll").forEach(t=>{e.observe(t)}),document.querySelectorAll(".counter").forEach(t=>{e.observe(t)}),ve(),window.animationObserver=e}function he(s,e,t=2e3){const a=e/(t/16);let r=0;const n=setInterval(()=>{r+=a,r>=e?(s.textContent=e,clearInterval(n)):s.textContent=Math.floor(r)},16)}function ve(){const s=document.querySelectorAll("img[data-src]"),e=new IntersectionObserver((t,o)=>{t.forEach(a=>{if(a.isIntersecting){const r=a.target;r.src=r.dataset.src;const n=()=>{r.classList.add("opacity-100"),r.classList.remove("opacity-0"),r.removeAttribute("data-src")};r.complete?n():r.onload=n,o.unobserve(r)}})},{threshold:.1,rootMargin:"0px 0px 200px 0px"});s.forEach(t=>e.observe(t))}const L="";async function be(){const s=l=>l==="/"?"/":`${L}${l}`,o=new Date().getFullYear()-2023;let a=[],r=[],n=[];try{a=await c.getHomepageSlides(),r=await c.getServices(),n=await c.getStatistics()}catch{console.log("Using fallback data for development"),a=[{title:"Unity, Service, Excellence & Integrity",button_text:"Learn More"}],r=[{title:"Community Building",description:"Fostering unity among Muslim public servants",icon:"users"},{title:"Professional Development",description:"Enhancing skills and career growth",icon:"briefcase"},{title:"Welfare Support",description:"Supporting members in times of need",icon:"heart"}],n=[{label:"Years of Service",value:o},{label:"Active Members",value:500},{label:"Programmes",value:50},{label:"Regions",value:16}]}return`
    ...
    <\/script>
  `}function xe(s){const e={users:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>',briefcase:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>',heart:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>',star:'<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/>'};return e[s]||e.users}async function fe(){return`
    <div class="pt-32">
      <!-- Page Header -->
  ...
  `}async function Ce(s){const{id:e}=s;let t=null;try{t=await c.getEventDetails(e)}catch(o){console.error("Error fetching programme details:",o)}return!t||Object.keys(t).length===0?`
    ...
    `}const N=s=>s==="/"?"/":`${L}${s}`;let v={category:"",search:"",page:1,limit:9},oe=1,te=null;window.filterBlogCategory=async(s,e)=>{v.category=s===v.category?"":s,v.page=1,document.querySelectorAll(".blog-category-link").forEach(t=>{t.classList.remove("text-primary-500","font-bold"),t.classList.add("text-neutral-400")}),v.category&&e&&(e.classList.remove("text-neutral-400"),e.classList.add("text-primary-500","font-bold")),await J()};window.handlePublicBlogSearch=s=>{clearTimeout(te),te=setTimeout(async()=>{v.search=s,v.page=1,await J()},500)};window.changeBlogPage=async s=>{s<1||s>oe||(v.page=s,await J(),document.getElementById("blog-grid").scrollIntoView({behavior:"smooth"}))};window.handleImageError=s=>{s.onerror=null;const e=s.parentElement;e.innerHTML='<div class="w-full h-full bg-gradient-to-br from-primary-500/20 to-accent-500/20 group-hover:scale-110 transition-transform duration-700"></div>'};window.toggleBlogFilters=()=>{const s=document.getElementById("blog-filters-container"),e=document.getElementById("filter-toggle-arrow");s&&(s.classList.toggle("hidden"),e&&e.classList.toggle("rotate-180"))};async function J(){const s=document.getElementById("blog-grid"),e=document.getElementById("blog-pagination");if(s){s.innerHTML='<div class="col-span-full text-center py-20 text-neutral-500">Loading...</div>',e&&(e.innerHTML="");try{const t=(v.page-1)*v.limit,o=await c.getBlogPosts({category:v.category,search:v.search,limit:v.limit,offset:t}),a=o.length===v.limit,r=v.page>1;if(oe=a?v.page+1:v.page,o.length===0){s.innerHTML=`
            ...
            `;return}s.innerHTML=o.map((l,i)=>re(l,i)).join(""),$e(r,a),s.querySelectorAll(".animate-on-scroll").forEach((l,i)=>{l.style.animationDelay=`${i*.1}s`,l.offsetWidth,l.classList.add("animate")})}catch{s.innerHTML='<div class="col-span-full text-center py-20 text-red-500">Error loading posts</div>'}}}function $e(s,e){const t=document.getElementById("blog-pagination");t&&(t.innerHTML=`
    ...
    <article class="glass rounded-xl overflow-hidden group hover-lift hover-glow animate-on-scroll flex flex-col h-full" style="animation-delay: ${e*.1}s">
        <a href="${N(`/blog-news/${s.id||e}`)}" class="block h-48 overflow-hidden relative shrink-0">
        ...
        <div class="p-5 flex flex-col flex-grow">
            <div class="flex items-center justify-between mb-2">
                ...
                <span class="text-xs text-neutral-500">${R(s.date)||"Recent"}</span>
            </div>
            <h2 class="text-lg font-bold mb-2 leading-tight hover:text-primary-500 transition-colors">
                <a href="${N(`/blog-news/${s.id||e}`)}">${s.title}</a>
            </h2>
            <p class="text-neutral-400 text-sm mb-4 line-clamp-3 leading-snug flex-grow">${s.excerpt||""}</p>
            <a href="${N(`/blog-news/${s.id||e}`)}" class="text-primary-500 text-xs font-bold uppercase tracking-widest hover:underline inline-flex items-center gap-1 group-hover:gap-2 transition-all mt-auto">
                Read more <span class="transition-transform group-hover:translate-x-1">→</span>
            </a>
        </div>
    </article>
  `}async function _e(){let s=[],e=[];v={category:"",search:"",page:1,limit:9};try{const[o,a]=await Promise.all([c.getBlogPosts({limit:9,offset:0}),c.getBlogCategories()]);s=o,e=a}catch{console.log("Using fallback data"),e=["General","Ramadan","Brotherhood","News"],s=[{title:"Welcome to PUSMAG",excerpt:"Learn about our mission and vision for the future of Muslim public servants in Ghana.",date:"2026-01-01",author:"Admin",category:"General",image:"https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=800&auto=format&fit=crop&q=60"}]}const t=s.length===v.limit;return`
    <div class="pt-32">
      <!-- Page Header -->
      <section class="section-padding bg-gradient-to-br from-primary-500/10 to-accent-500/10">
        <div class="container-custom text-center">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div class="lg:col-span-3">
                <div id="blog-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
                    ${s.length>0?s.map((o,a)=>re(o,a)).join(""):`
  ...
  `}async function je(s){const{id:e}=s;let t=null;try{t=await c.getBlogPost(e)}catch(o){console.error("Error fetching blog post:",o)}return!t||Object.keys(t).length===0?`
            <div class="pt-32 min-h-screen flex items-center justify-center">
                <div class="text-center">
    ...
    <div class="relative min-h-[60vh] flex items-center justify-center pb-20">
        ...
        <div class="container relative z-10 text-center pt-32 px-4">
            ...
            <div class="flex items-center justify-center gap-6 text-neutral-300 animate-fade-in-up" style="animation-delay: 0.2s">
                ...
                <span class="font-medium tracking-wide">${R(t.date)}</span>
            </div>
        </div>
    </div>
    ...
    `}async function Ee(){let s=[],e=[];try{const[r,n]=await Promise.all([c.getGalleryImages({limit:100}),c.getGalleryCategories()]);s=r,e=n}catch{console.log("Using fallback data"),s=Array(6).fill(null).map((n,l)=>({id:l,title:"Gallery Image",category:l%2===0?"Events":"Meetings"})),e=["Events","Meetings"]}const o=`
    <div class="pt-32">
      <section class="section-padding bg-gradient-to-br from-primary-500/10 to-accent-500/10">
        <div class="container-custom text-center">
  ...
  `;window.galleryData={images:s,currentIndex:0},window.openGalleryLightbox=(r,n=!1)=>{const l=document.getElementById("gallery-lightbox"),i=document.getElementById("lightbox-image"),d=document.getElementById("lightbox-title"),u=document.getElementById("lightbox-category"),h=document.getElementById("lightbox-counter"),p=()=>{window.galleryData.currentIndex=r;const g=window.galleryData.images[r];g.image_url?i.src=g.image_url:i.src="placeholder",d.textContent=g.title||"Untitled",u.textContent=g.category||"General";const w=document.querySelector(".filter-btn.active").dataset.filter,b=w==="all"?window.galleryData.images:window.galleryData.images.filter(y=>y.category===w),m=b.findIndex(y=>y.id===g.id);h.textContent=`${m+1} / ${b.length}`};n?(i.classList.add("animate-gallery-fade-out"),setTimeout(()=>{i.classList.remove("animate-gallery-fade-out"),p(),i.classList.add("animate-gallery-fade-in"),setTimeout(()=>i.classList.remove("animate-gallery-fade-in"),300)},300)):p(),l.classList.remove("hidden"),document.body.style.overflow="hidden"},window.closeGalleryLightbox=()=>{const r=document.getElementById("gallery-lightbox");r&&(r.classList.add("hidden"),document.body.style.overflow="")},window.nextGalleryImage=()=>{const r=document.querySelector(".filter-btn.active").dataset.filter,n=r==="all"?window.galleryData.images:window.galleryData.images.filter(p=>p.category===r),l=window.galleryData.images[window.galleryData.currentIndex].id;let d=(n.findIndex(p=>p.id===l)+1)%n.length;const u=n[d],h=window.galleryData.images.findIndex(p=>p.id===u.id);window.openGalleryLightbox(h,!0)},window.prevGalleryImage=()=>{const r=document.querySelector(".filter-btn.active").dataset.filter,n=r==="all"?window.galleryData.images:window.galleryData.images.filter(p=>p.category===r),l=window.galleryData.images[window.galleryData.currentIndex].id;let d=(n.findIndex(p=>p.id===l)-1+n.length)%n.length;const u=n[d],h=window.galleryData.images.findIndex(p=>p.id===u.id);window.openGalleryLightbox(h,!0)};const a=r=>{r.key==="Escape"&&window.closeGalleryLightbox(),r.key==="ArrowRight"&&window.nextGalleryImage(),r.key==="ArrowLeft"&&window.prevGalleryImage()};return document.removeEventListener("keydown",a),document.addEventListener("keydown",a),setTimeout(()=>{const r=document.querySelectorAll(".filter-btn"),n=document.querySelectorAll(".gallery-item");r.forEach(l=>{l.addEventListener("click",()=>{r.forEach(d=>{d.classList.remove("active","bg-white/10","text-neutral-300"),d.classList.add("text-neutral-400")}),l.classList.add("active","bg-white/10","text-neutral-300"),l.classList.remove("text-neutral-400");const i=l.dataset.filter;n.forEach(d=>{const u=d.dataset.category;i==="all"||u===i?(d.style.display="block",d.style.animation="none",d.offsetHeight,d.style.animation="zoomIn 0.4s ease-out forwards"):d.style.display="none"})})})},0),o}async function Ie(){return`
    ...
    <\/script>
  `}class k{static init(){if(document.getElementById("custom-modal-container"))return;const e=document.createElement("div");e.id="custom-modal-container",e.className="fixed inset-0 z-[100] hidden items-center justify-center p-4 bg-neutral-900/60 backdrop-blur-sm transition-opacity duration-300",e.innerHTML=`
        ...
        `,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&k.close()})}static show({title:e,message:t,type:o="info",onConfirm:a=null,confirmText:r="Okay",cancelText:n=null}){this.init();const l=document.getElementById("custom-modal-container"),i=document.getElementById("custom-modal-content"),d=document.getElementById("custom-modal-title"),u=document.getElementById("custom-modal-message"),h=document.getElementById("custom-modal-icon"),p=document.getElementById("custom-modal-actions");d.textContent=e,u.textContent=t;let g="",w="text-primary-500",b="bg-primary-500/10";o==="error"?(w="text-red-500",b="bg-red-500/10",g='<svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>'):o==="success"?(w="text-emerald-500",b="bg-emerald-500/10",g='<svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>'):g='<svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>',h.innerHTML=g,h.className=`w-20 h-20 rounded-full flex items-center justify-center mx-auto ${b}`,h.firstElementChild.classList.add(w),p.innerHTML="";const m=document.createElement("button");if(m.className="btn-custom w-full",m.innerHTML=`<span class="inner">${r}</span>`,m.onclick=()=>{a&&a(),k.close()},p.appendChild(m),n){const y=document.createElement("button");y.className="px-6 py-3 text-neutral-400 hover:text-neutral-300 transition-colors text-sm font-medium",y.textContent=n,y.onclick=()=>k.close(),p.appendChild(y)}l.classList.remove("hidden"),l.classList.add("flex"),requestAnimationFrame(()=>{i.classList.remove("scale-95","opacity-0"),i.classList.add("scale-100","opacity-100")})}static close(){const e=document.getElementById("custom-modal-container"),t=document.getElementById("custom-modal-content");!e||!t||(t.classList.remove("scale-100","opacity-100"),t.classList.add("scale-95","opacity-0"),setTimeout(()=>{e.classList.add("hidden"),e.classList.remove("flex")},300))}static alert(e,t){this.show({title:e,message:t,type:"error"})}static success(e,t){this.show({title:e,message:t,type:"success"})}}window.Modal=k;window.addMembershipRow=()=>{const s=document.getElementById("memberships-container");if(!s)return;const e=document.createElement("div");e.className="membership-row grid grid-cols-12 gap-2 p-2 border-t border-white/5",e.innerHTML=`
  ...
  `}const Ae=s=>{if(!s)return"";const[e,t]=s.split("@");return t?e.length<=2?`${e}***@${t}`:`${e.substring(0,2)}***${e.substring(e.length-2)}@${t}`:s},Te=s=>{if(!s)return"";const e=s.replace(/[^\d+]/g,"");let t="",o=e;return e.startsWith("+")&&(t=e.substring(0,4),o=e.substring(4)),o.length<=3?`${t}***${o}`:`${t}${"*".repeat(o.length-3)}${o.slice(-3)}`};window.handleLoginSubmit=async s=>{s.preventDefault();const e=s.target,t=e.usr.value,o=e.pwd.value,a=document.getElementById("login-message"),r=e.querySelector('button[type="submit"]');r.disabled=!0,r.innerHTML='<span class="inner">Checking...</span>',a.classList.add("hidden");try{await c.login(t,o);const n=await c.send2FACode(t);document.getElementById("login-section").classList.add("hidden"),document.getElementById("2fa-section").classList.remove("hidden");const l=document.getElementById("2fa-email-display");n.method==="SMS"?l.textContent=Te(n.mobile_no):l.textContent=Ae(n.email),l.setAttribute("data-full-email",t)}catch(n){a.textContent=n.message||"Login failed. Please check your credentials.",a.className="p-4 rounded bg-red-500/10 border border-red-500/20 text-red-500 mb-6",a.classList.remove("hidden"),r.disabled=!1,r.innerHTML='<span class="inner">Sign In</span>'}};window.handle2FASubmit=async s=>{s.preventDefault();const e=s.target,t=e.code.value,o=document.getElementById("2fa-email-display").getAttribute("data-full-email"),a=document.getElementById("2fa-message"),r=e.querySelector('button[type="submit"]');r.disabled=!0,r.innerHTML='<span class="inner">Verifying...</span>';try{await c.verify2FACode(o,t),f.user=await c.getUserInfo(),f.navigate("/portal/dashboard")}catch(n){a.textContent=n.message||"Invalid code. Please try again.",a.className="p-4 rounded bg-red-500/10 border border-red-500/20 text-red-500 mb-6",a.classList.remove("hidden"),r.disabled=!1,r.innerHTML='<span class="inner">Verify Code</span>'}};window.togglePassword=()=>{const s=document.querySelector('input[name="pwd"]'),e=document.getElementById("eye-icon"),t=document.getElementById("eye-off-icon");s.type==="password"?(s.type="text",e.classList.add("hidden"),t.classList.remove("hidden")):(s.type="password",e.classList.remove("hidden"),t.classList.add("hidden"))};async function He(){return`
    ...
    `}let j=1;const F=12;let A={};window.changeMemberPage=s=>{j=s,q(),document.getElementById("members-grid-container")?.scrollIntoView({behavior:"smooth"})};window.handleMemberSearch=s=>{const e=s.target.value;A.search=e,j=1,q()};window.handleMemberFilter=s=>{const{name:e,value:t}=s.target;t?A[e]=t:delete A[e],j=1,q()};window.toggleMemberFilters=()=>{const s=document.getElementById("member-filters-container"),e=document.getElementById("member-filter-toggle-arrow");s&&(s.classList.toggle("hidden"),e&&e.classList.toggle("rotate-180"))};async function q(){const s=document.getElementById("members-grid-container");if(s){s.innerHTML='<div class="col-span-full py-20 text-center text-neutral-500">Searching members...</div>';try{const{members:e,total:t}=await c.getMemberDirectory({...A,limit:F,offset:(j-1)*F});if(e.length===0){s.innerHTML='<div class="col-span-full py-20 text-center text-neutral-500">No members found matching your criteria.</div>';return}s.innerHTML=e.map(a=>`
        ...
        `).join("");const o=document.getElementById("members-pagination");if(o){const a=Math.ceil(t/F);let r="";for(let n=1;n<=a;n++)r+=`
                    <button onclick="window.changeMemberPage(${n})" 
                            class="w-10 h-10 rounded-lg flex items-center justify-center transition-all ${j===n?"bg-primary-500 text-neutral-300":"glass text-neutral-400 hover:text-neutral-300"}">
                        ${n}
                    </button>
                `;o.innerHTML=r}setTimeout(()=>B(),100)}catch(e){s.innerHTML=`<div class="col-span-full py-20 text-center text-red-500">Error loading members: ${e.message}</div>`}}}async function Re(){return setTimeout(()=>q(),100),`
    ...
    `}window.openBlogPost=s=>{f.navigate(s)};let O="",M=null,T=null;const qe=()=>{M||!document.getElementById("editor-container")||(M=new Quill("#editor-container",{theme:"snow",modules:{toolbar:[[{header:[1,2,3,!1]}],["bold","italic","underline","strike"],["blockquote","code-block"],[{list:"ordered"},{list:"bullet"}],["link","image"],["clean"]]},placeholder:"Write your post content here..."}))};window.handlePortalBlogSearch=s=>{O=s.target.value,P()};window.toggleBlogPortalSearch=()=>{const s=document.getElementById("blog-portal-search-container"),e=document.getElementById("blog-portal-search-toggle-arrow");s&&(s.classList.toggle("hidden"),e&&e.classList.toggle("rotate-180"))};window.openBlogModal=async(s=null)=>{const e=document.getElementById("blog-modal"),t=document.getElementById("blog-form"),o=document.getElementById("blog-modal-title");if(setTimeout(()=>qe(),100),t.reset(),t.name.value=s||"",M&&M.setContents([]),o.textContent=s?"Edit Blog Post":"Create New Post",s)try{const a=await c.getBlogPostDetails(s);t.post_title.value=a.post_title,t.post_category.value=a.post_category,t.post_image.value=a.post_image||"";const r=document.getElementById("image-preview"),n=r.querySelector("img"),l=r.querySelector(".empty-state");a.post_image?(n.src=a.post_image,n.classList.remove("hidden"),l.classList.add("hidden")):(n.src="",n.classList.add("hidden"),l.classList.remove("hidden")),M&&M.clipboard.dangerouslyPasteHTML(a.post_content||"")}catch(a){alert("Error loading post: "+a.message);return}else{const a=document.getElementById("image-preview");a.querySelector("img").src="",a.querySelector("img").classList.add("hidden"),a.querySelector(".empty-state").classList.remove("hidden")}e.classList.remove("hidden"),e.classList.add("flex")};window.closeBlogModal=()=>{const s=document.getElementById("blog-modal");s.classList.add("hidden"),s.classList.remove("flex")};window.handleImageUpload=async s=>{const e=s.target.files[0];if(!e)return;if(!["image/jpeg","image/jpg","image/png"].includes(e.type)){alert("Please upload a valid image file (JPG or PNG).");return}if(e.size>2*1024*1024){k.alert("File too large","File size too large. Maximum 2MB allowed.");return}const o=document.getElementById("image-preview"),a=o.querySelector("img"),r=o.querySelector(".empty-state"),n=document.querySelector('input[name="post_image"]'),l=document.querySelector('button[onclick*="image-upload-input"]');try{l.disabled=!0,l.innerHTML='<svg class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg> Uploading...';const i=await c.uploadFile(e);n.value=i,a.src=i,a.classList.remove("hidden"),r.classList.add("hidden")}catch(i){alert("Upload failed: "+i.message)}finally{l.disabled=!1,l.innerHTML='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a2 2 0 002 2h12a2 2 0 002-2v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path></svg> Upload Image'}};window.handleBlogSubmit=async s=>{s.preventDefault();const e=s.target,t=e.querySelector('button[type="submit"]'),o=M?M.root.innerHTML:"";if(o==="<p><br></p>"){alert("Post content cannot be empty.");return}const a={name:e.name.value,post_title:e.post_title.value,post_category:e.post_category.value,post_image:e.post_image.value,post_content:o,route:e.post_title.value.toLowerCase().replace(/ /g,"-").replace(/[^\w-]+/g,""),delete_requested:0};t.disabled=!0,t.innerHTML='<span class="inner">Saving...</span>';try{await c.saveBlogPost(a),closeBlogModal(),P()}catch(r){alert("Error saving post: "+r.message)}finally{t.disabled=!1,t.innerHTML='<span class="inner">Save Post</span>'}};window.openDeleteModal=s=>{T=s;const e=document.getElementById("delete-modal");e.classList.remove("hidden"),e.classList.add("flex")};window.closeDeleteModal=()=>{T=null;const s=document.getElementById("delete-modal");s.classList.add("hidden"),s.classList.remove("flex")};window.handleDeleteConfirm=async()=>{if(!T)return;const s=document.getElementById("confirm-delete-btn");s.disabled=!0,s.innerHTML='<span class="inner">Deleting...</span>';try{const e=await c.deleteBlogPost(T);e.status==="requested"&&alert(e.message),closeDeleteModal(),P()}catch(e){alert("Error deleting post: "+e.message)}finally{s.disabled=!1,s.innerHTML='<span class="inner">Delete Post</span>'}};window.handleCancelDelete=async s=>{try{await c.cancelDeleteRequest(s),P()}catch(e){alert("Error cancelling request: "+e.message)}};window.handleVerifyToggle=async(s,e)=>{try{await c.publishBlogPost(s,e?0:1,null),P()}catch(t){alert("Error updating verification: "+t.message)}};window.handlePublishToggle=async(s,e)=>{try{await c.publishBlogPost(s,null,e?0:1),P()}catch(t){alert("Error updating publication: "+t.message)}};async function P(){const s=document.getElementById("blog-posts-container");if(s){s.innerHTML='<tr><td colspan="5" class="py-20 text-center text-neutral-500">Loading your posts...</td></tr>';try{const e=await c.getUserBlogPosts(O);if(e.length===0){s.innerHTML=`<tr><td colspan="5" class="py-20 text-center text-neutral-500">${O?"No posts match your search.":"No blog posts found."}</td></tr>`;return}s.innerHTML=e.map(t=>`
            <tr class="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                ...
                <td class="py-4 px-6 text-xs text-neutral-500 whitespace-nowrap">${W(t.published_date)}</td>
                <td class="py-4 px-6 text-right">
                    <div class="flex justify-end gap-2">
                        ${f.user.roles.includes("PuSMAG Admin")?`
                            <button onclick="window.handleVerifyToggle('${t.name}', ${t.verified?1:0})" class="p-2 ${t.verified?"text-blue-500 hover:text-blue-400":"text-neutral-500 hover:text-blue-500"} transition-colors" title="${t.verified?"Unverify":"Verify"}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                            </button>
                            <button onclick="window.handlePublishToggle('${t.name}', ${t.published?1:0})" class="p-2 ${t.published?"text-emerald-500 hover:text-emerald-400":"text-neutral-500 hover:text-emerald-500"} transition-colors" title="${t.published?"Unpublish":"Publish"}">
        ...
        `).join(""),setTimeout(()=>B(),100)}catch(e){s.innerHTML=`<tr><td colspan="5" class="py-20 text-center text-red-500">Error: ${e.message}</td></tr>`}}}async function ze(){return setTimeout(()=>P(),100),`
        <div class="space-y-8 animate-on-scroll">
    ...
    `}window.approveRegistration=async s=>{if(confirm("Are you sure you want to approve this registration? This will create a user account and member record."))try{await c.approveRegistration(s),alert("Registration approved successfully!"),Y()}catch(e){alert("Error: "+e.message)}};window.rejectRegistration=async s=>{const e=prompt("Please provide a reason for rejection:");if(e!==null)try{await c.rejectRegistration(s,e),alert("Registration rejected."),Y()}catch(t){alert("Error: "+t.message)}};async function Y(){const s=document.getElementById("registrations-container");if(s){s.innerHTML='<tr><td colspan="5" class="py-20 text-center text-neutral-500 text-lg">Loading registrations...</td></tr>';try{const e=await c.getPendingRegistrations();if(e.length===0){s.innerHTML='<tr><td colspan="5" class="py-20 text-center text-neutral-500 text-lg">No pending registrations found.</td></tr>';return}s.innerHTML=e.map(t=>`
            <tr class="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                ...
                <td class="py-4 px-6 text-xs text-neutral-500 whitespace-nowrap">${W(t.creation)}</td>
                <td class="py-4 px-6 text-right">
                    <div class="flex justify-end gap-2">
        ...
        `).join("")}catch(e){s.innerHTML=`<tr><td colspan="5" class="py-20 text-center text-red-500">Error: ${e.message}</td></tr>`}}}async function Ne(){return setTimeout(()=>Y(),100),`
        <div class="space-y-8 animate-on-scroll">
    ...
    `}let ne=null;window.handleSendContactRequest=async()=>{const s=document.getElementById("contact-request-submit-btn");s.disabled=!0,s.innerHTML='<span class="inner">Sending...</span>';try{const e=await c.requestContactAccess(ne);switch(closeContactRequestModal(),e.status){case"requested":I("Request sent. You will be notified once the member responds.","success"),U("pending");break;case"already_pending":I("Your request is still pending approval.","info"),U("pending");break;case"already_approved":I("You already have access. Refresh to view contact info.","info");break;case"cooldown":I("You must wait 24 hours before requesting again.","warning"),U("rejected_cooldown");break}}catch(e){alert("Error sending request: "+e.message)}finally{s.disabled=!1,s.innerHTML='<span class="inner">Send Request</span>'}};window.openContactRequestModal=()=>{const s=document.getElementById("contact-request-modal");s.classList.remove("hidden"),s.classList.add("flex")};window.closeContactRequestModal=()=>{const s=document.getElementById("contact-request-modal");s.classList.add("hidden"),s.classList.remove("flex")};function I(s,e="info"){const t={success:"bg-emerald-500/10 border-emerald-500/30 text-emerald-400",info:"bg-blue-500/10 border-blue-500/30 text-blue-400",warning:"bg-amber-500/10 border-amber-500/30 text-amber-400",error:"bg-red-500/10 border-red-500/30 text-red-400"},o=document.createElement("div");o.className=`fixed bottom-6 right-6 z-[100] px-5 py-3 rounded-xl border text-sm font-medium shadow-xl transition-all duration-300 ${t[e]||t.info}`,o.textContent=s,document.body.appendChild(o),setTimeout(()=>o.remove(),4e3)}function U(s){const e=document.getElementById("contact-email-slot"),t=document.getElementById("contact-phone-slot"),o=document.getElementById("info-email-slot"),a=document.getElementById("info-phone-slot");e&&(e.outerHTML=H("email",s,null)),t&&(t.outerHTML=H("phone",s,null)),o&&(o.outerHTML=D("email",s,null)),a&&(a.outerHTML=D("phone",s,null))}function H(s,e,t){const o=s==="email",a=o?"contact-email-slot":"contact-phone-slot",r=o?"Email":"Phone",n=o?"M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z":"M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z";if(e==="self_or_admin"||e==="approved"){const u=o?`mailto:${t}`:`tel:${t}`;return`<a id="${a}" href="${u}" class="p-3 glass rounded-xl ${o?"hover:text-primary-500":"hover:text-emerald-500"} transition-colors" title="${t||r}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="${n}"></path></svg>
        </a>`}if(e==="pending")return`<div id="${a}" class="p-3 glass rounded-xl text-amber-500 cursor-default relative group" title="Request pending approval">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="${n}"></path></svg>
            <span class="absolute -top-1 -right-1 w-3 h-3 rounded-full bg-amber-500 border-2 border-neutral-900"></span>
        </div>`;const l=e==="rejected_cooldown"?"":'onclick="window.openContactRequestModal()"',i=e==="rejected_cooldown"?"cursor-not-allowed":"cursor-pointer hover:text-primary-500",d={none:`Request access to ${r.toLowerCase()}`,rejected:"Previous request declined — click to request again",rejected_cooldown:"Request declined — try again after 24 hours"};return`<button id="${a}" ${l} class="p-3 glass rounded-xl text-neutral-500 ${i} transition-colors relative group" title="${d[e]||"Request access"}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="${n}"></path></svg>
    ...
    </button>`}function D(s,e,t){const o=s==="email",a=o?"info-email-slot":"info-phone-slot";return e==="self_or_admin"||e==="approved"?`<span id="${a}" class="font-medium truncate ml-4" title="${t}">${t||"N/A"}</span>`:e==="pending"?`<span id="${a}" class="font-medium text-amber-500/70 text-xs italic ml-4">Request pending…</span>`:e==="rejected_cooldown"?`<span id="${a}" class="font-medium text-red-500/70 text-xs italic ml-4">Request declined</span>`:`<button id="${a}" onclick="window.openContactRequestModal()" class="font-medium text-xs text-neutral-500 hover:text-primary-500 ml-4 transition-colors flex items-center gap-1">
        ...
        Request ${o?"email":"phone"}
    </button>`}function Fe(s,e,t){if(t==="pending"||t==="self_or_admin"||t==="approved"||t==="rejected_cooldown")return"";const o=t==="rejected";return`
        <div id="contact-request-modal" class="fixed inset-0 z-[70] hidden items-center justify-center p-4 bg-neutral-900/60 backdrop-blur-sm">
            <div class="glass w-full max-w-md rounded-2xl overflow-hidden">
                <div class="p-8 space-y-6 text-center">
                    ...
                    <div>
                        <h3 class="text-xl font-bold mb-2">${o?"Request Access Again":"Contact Info Protected"}</h3>
                        <p class="text-neutral-400 text-sm leading-relaxed">
                            ${o?`Your previous request was declined. You may send a new request to <strong class="text-neutral-300">${e}</strong>.`:`Viewing <strong class="text-neutral-300">${e}'s</strong> contact information requires their approval. They will be notified and you will receive a response by email or SMS.`}
                        </p>
                    </div>
                    <div class="flex flex-col gap-3">
    ...
    `}async function Ue(s){const e=s.name;if(!e)return'<div class="py-20 text-center">Member not found</div>';let t=null;try{t=await c.getMemberDetails(e)}catch(n){return`<div class="py-20 text-center text-red-500">Error: ${n.message}</div>`}if(!t)return'<div class="py-20 text-center">Member not found</div>';ne=e;const o=t.contact_access||"none",a=t.email_address||null,r=t.mobile_number||null;return`
        <div class="space-y-8 animate-on-scroll">
            <div class="flex items-center gap-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-6">
                    <div class="glass p-8 rounded-3xl flex flex-col items-center text-center">
                        ...
                        ${o!=="self_or_admin"&&o!=="approved"?`
                        <p class="text-[10px] text-neutral-600 mt-3 flex items-center justify-center gap-1.5">
                            ${o==="pending"?'<svg class="w-3 h-3 text-amber-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg><span>Contact request pending approval</span>':`<svg class="w-3 h-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"></path></svg><span>${o==="rejected_cooldown"?"Contact request declined — 24 h cooldown":"Contact info requires approval"}</span>`}
                        </p>`:""}
                    </div>
                    ...
                    <div class="glass p-8 rounded-3xl">
                        ...
                        <div class="mt-8 space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ${t.professional_memberships.map(n=>`
                                    <div class="p-4 rounded-xl bg-white/5 border border-white/5">
                                        <p class="font-medium text-sm">${n.professional_body||"Body"}</p>
                                        <p class="text-xs text-neutral-500">${n.profession||"Profession"}</p>
                                    </div>
                                `).join("")}
                            </div>
                        </div>
        ...
        ${Fe(e,t.first_name,o)}
    `}let S=[],le=null;async function Ve(){return setTimeout(Q,0),`
        <div class="space-y-8 animate-on-scroll">
            <div class="flex items-center justify-between">
                <div>
    ...
    `}let C=null;async function Q(){const s=document.getElementById("programmes-container");if(s)try{if(S=await c.getPortalProgrammes(),S.length===0){s.innerHTML='<tr><td colspan="4" class="py-12 text-center text-neutral-500 italic">No programmes found. Create your first one above!</td></tr>';return}s.innerHTML=S.map(e=>`
            <tr class="border-b border-white/5 hover:bg-white/[0.02] transition-colors group">
                ...
                <td class="py-4 px-6">
                    <p class="text-sm font-medium text-neutral-300 whitespace-nowrap">${W(e.start_date)}</p>
                </td>
                <td class="py-4 px-6 text-right">
                    <div class="flex justify-end gap-2">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 p-4 glass rounded-xl border border-white/5 group">
            ...
            <div class="flex-grow grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                ...
                <select onchange="window.updateStagedFile('${t.id}', 'category', this.value)"
                        class="bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-xs text-neutral-300 focus:border-accent-500 outline-none w-full"
                        ${t.status!=="pending"?"disabled":""}>
                    ${de.map(a=>`<option value="${a}" ${t.category===a?"selected":""} class="bg-neutral-900">${a}</option>`).join("")}
                </select>
            </div>
    ...
    `).join("")}}window.startBulkUpload=async()=>{if(x.length===0){alert("Please select images to upload first.");return}const s=document.getElementById("start-bulk-upload-btn"),e=document.getElementById("close-gallery-modal-btn");s.disabled=!0,s.innerHTML='<span class="inner">Processing...</span>',e&&(e.disabled=!0);for(const a of x)if(a.status!=="success"){try{a.status="uploading",E();const r=await c.uploadFile(a.file);await c.saveGalleryImage({image_title:a.title,image_category:a.category,image_link:r}),a.status="success"}catch(r){console.error(r),a.status="error"}E()}const t=x.filter(a=>a.status==="success").length;s.innerHTML=`<span class="inner">Uploaded ${t}/${x.length}</span>`,e&&(e.disabled=!1),z(),x.filter(a=>a.status!=="success").length===0?setTimeout(()=>{window.closeGalleryModal(),x.forEach(a=>URL.revokeObjectURL(a.preview)),x=[]},2e3):(s.disabled=!1,s.innerHTML='<span class="inner">Retry Failed</span>')};async function Oe(){return setTimeout(z,0),`
        <div class="space-y-8 animate-on-scroll">
            <div class="flex items-center justify-between">
                <div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select name="image_category" required class="text-xs w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:border-accent-500 transition-colors outline-none text-neutral-300 appearance-none bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20width%3D%2220%22%20height%3D%2220%22%20viewBox%3D%220%200%2020%2020%22%20fill%3D%22none%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%3Cpath%20d%3D%22M7%207L10%2010L13%207%22%20stroke%3D%22%23a3a3a3%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22/%3E%3C/svg%3E')] bg-[length:20px] bg-[right_1rem_center] bg-no-repeat">
                                        ${de.map(s=>`<option value="${s}" class="bg-neutral-900">${s}</option>`).join("")}
                                    </select>
                                </div>
                            </div>
    ...
    `}async function z(){const s=document.getElementById("gallery-grid");if(s)try{if($=await c.getPortalGallery(),$.length===0){s.innerHTML='<div class="lg:col-span-4 py-20 text-center text-neutral-500 italic">No images in gallery. Upload your first one above!</div>';return}window.galleryData={images:$,currentIndex:0},s.innerHTML=$.map((e,t)=>`
        ...
        `).join(""),setTimeout(()=>B(),100)}catch(e){s.innerHTML=`<div class="lg:col-span-4 py-20 text-center text-red-500">Error: ${e.message}</div>`}}window.openGalleryModal=(s=null)=>{const e=document.getElementById("gallery-modal"),t=document.getElementById("gallery-form"),o=document.getElementById("gallery-image-preview"),a=e.querySelector("h3"),r=document.getElementById("gallery-submit-btn"),n=e.querySelector(".flex.border-b.border-white\\/5");if(_=s,t.reset(),o.innerHTML='<svg class="w-12 h-12 text-neutral-800" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>',x.forEach(l=>URL.revokeObjectURL(l.preview)),x=[],E(),window.toggleGalleryUploadTab("single"),s){n&&n.classList.add("hidden");const l=$.find(i=>i.name===s);l&&(t.image_title.value=l.image_title||"",t.image_category.value=l.image_category||"Event",t.image_link.value=l.image_link||"",l.image_link&&(o.innerHTML=`<img src="${l.image_link}" class="w-full h-full object-cover">`,r.disabled=!1),a.innerText="Edit Media",r.innerHTML='<span class="inner">Update Image</span>')}else n&&n.classList.remove("hidden"),a.innerText="Add Media",r.innerHTML='<span class="inner">Add to Gallery</span>',r.disabled=!0;e.classList.remove("hidden"),e.classList.add("flex"),document.body.style.overflow="hidden"};window.closeGalleryModal=()=>{const s=document.getElementById("gallery-modal");s.classList.add("hidden"),s.classList.remove("flex"),document.body.style.overflow="auto",x.forEach(e=>URL.revokeObjectURL(e.preview)),x=[]};window.handleGalleryImageUpload=async s=>{const e=s.files[0];if(!e)return;if(!["image/jpeg","image/jpg","image/png"].includes(e.type)){alert("ONLY JPG, JPEG, and PNG files are allowed.");return}if(e.size>2*1024*1024){alert("File size exceeds 2MB limit.");return}const t=document.getElementById("gallery-upload-status"),o=document.getElementById("gallery-image-preview"),a=document.getElementById("gallery-form").image_link,r=document.getElementById("gallery-submit-btn");try{t.classList.remove("hidden"),t.innerText="Uploading...",r.disabled=!0;const n=await c.uploadFile(e);a.value=n,o.innerHTML=`<img src="${n}" class="w-full h-full object-cover">`,t.innerText="Upload Complete",r.disabled=!1,setTimeout(()=>t.classList.add("hidden"),2e3)}catch(n){alert("Upload failed: "+n.message),t.classList.add("hidden"),r.disabled=!a.value}};window.handleGallerySubmit=async s=>{s.preventDefault();const e=s.target,t=document.getElementById("gallery-submit-btn"),o={name:_,image_title:e.image_title.value,image_category:e.image_category.value,image_link:e.image_link.value};if(!o.image_link){alert("Please upload an image first.");return}t.disabled=!0,t.innerHTML=`<span class="inner">${_?"Updating...":"Adding..."} Image</span>`;try{await c.saveGalleryImage(o),window.closeGalleryModal(),z()}catch(a){alert(`Error ${_?"updating":"adding"} gallery image: ${a.message}`)}finally{t.disabled=!1,t.innerHTML=`<span class="inner">${_?"Update":"Add to"} Gallery</span>`}};window.openDeleteGalleryModal=s=>{ie=s,document.getElementById("delete-gallery-modal").classList.remove("hidden")};window.closeDeleteGalleryModal=()=>{document.getElementById("delete-gallery-modal").classList.add("hidden")};window.handleDeleteGalleryConfirm=async()=>{const s=document.getElementById("confirm-gallery-delete-btn");s.disabled=!0,s.innerHTML="Deleting...";try{await c.deleteGalleryImage(ie),window.closeDeleteGalleryModal(),z()}catch(e){alert("Error deleting image: "+e.message)}finally{s.disabled=!1,s.innerHTML="Delete"}};window.openGalleryLightbox=(s,e=!1)=>{const t=document.getElementById("gallery-lightbox"),o=document.getElementById("lightbox-image"),a=document.getElementById("lightbox-title"),r=document.getElementById("lightbox-category"),n=document.getElementById("lightbox-counter"),l=()=>{window.galleryData.currentIndex=s;const i=window.galleryData.images[s];o.src=i.image_link||"",a.textContent=i.image_title||"Untitled",r.textContent=i.image_category||"General",n.textContent=`${s+1} / ${window.galleryData.images.length}`};e?(o.classList.add("animate-gallery-fade-out"),setTimeout(()=>{o.classList.remove("animate-gallery-fade-out"),l(),o.classList.add("animate-gallery-fade-in"),setTimeout(()=>o.classList.remove("animate-gallery-fade-in"),300)},300)):l(),t.classList.remove("hidden"),t.classList.add("flex"),document.body.style.overflow="hidden"};window.closeGalleryLightbox=()=>{const s=document.getElementById("gallery-lightbox");s&&(s.classList.add("hidden"),s.classList.remove("flex"),document.body.style.overflow="auto")};window.nextGalleryImage=()=>{if(!window.galleryData||!window.galleryData.images.length)return;const s=(window.galleryData.currentIndex+1)%window.galleryData.images.length;window.openGalleryLightbox(s,!0)};window.prevGalleryImage=()=>{if(!window.galleryData||!window.galleryData.images.length)return;const s=(window.galleryData.currentIndex-1+window.galleryData.images.length)%window.galleryData.images.length;window.openGalleryLightbox(s,!0)};const ce=s=>{const e=document.getElementById("gallery-lightbox");!e||e.classList.contains("hidden")||(s.key==="Escape"&&window.closeGalleryLightbox(),s.key==="ArrowRight"&&window.nextGalleryImage(),s.key==="ArrowLeft"&&window.prevGalleryImage())};document.removeEventListener("keydown",ce);document.addEventListener("keydown",ce);let G=null;window.handleApproveContactRequest=async s=>{const e=document.getElementById(`approve-btn-${s}`);e&&(e.disabled=!0,e.innerHTML="Approving...");try{await c.respondToContactRequest(s,"approve"),K()}catch(t){alert("Error approving request: "+t.message),e&&(e.disabled=!1,e.innerHTML="Approve")}};window.openRejectModal=s=>{G=s;const e=document.getElementById("contact-reject-modal"),t=document.getElementById("contact-reject-reason");t&&(t.value=""),e.classList.remove("hidden"),e.classList.add("flex")};window.closeRejectModal=()=>{G=null;const s=document.getElementById("contact-reject-modal");s.classList.add("hidden"),s.classList.remove("flex")};window.handleConfirmReject=async()=>{if(!G)return;const s=document.getElementById("contact-reject-reason")?.value||"",e=document.getElementById("confirm-reject-contact-btn");e.disabled=!0,e.innerHTML='<span class="inner">Declining...</span>';try{await c.respondToContactRequest(G,"reject",s),closeRejectModal(),K()}catch(t){alert("Error declining request: "+t.message)}finally{e.disabled=!1,e.innerHTML='<span class="inner">Decline Request</span>'}};async function K(){const s=document.getElementById("contact-requests-container");if(s){s.innerHTML='<div class="py-12 text-center text-neutral-500">Loading requests...</div>';try{const e=await c.getContactAccessRequests();if(e.length===0){s.innerHTML='<div class="py-12 text-center text-neutral-500">No pending contact access requests.</div>';return}s.innerHTML=e.map(t=>`
            <div class="flex items-center justify-between p-4 sm:p-5 rounded-xl bg-white/5 border border-white/10 gap-4">
                <div class="flex items-center gap-4 min-w-0">
                    ...
                    <div class="min-w-0">
                        <p class="font-semibold text-sm text-neutral-300 truncate">${t.requester_name}</p>
                        <p class="text-[10px] text-neutral-500 mt-0.5">${t.requester}</p>
                        <p class="text-[10px] text-neutral-600 mt-0.5">Requested ${new Date(t.requested_datetime).toLocaleDateString("en-GB",{day:"numeric",month:"short",year:"numeric"})}</p>
                    </div>
                </div>
                <div class="flex gap-2 flex-shrink-0">
                    <button id="approve-btn-${t.name}" onclick="window.handleApproveContactRequest('${t.name}')"
                    ...
                    <button onclick="window.openRejectModal('${t.name}')"
        ...
        `).join(""),setTimeout(()=>B(),100)}catch(e){s.innerHTML=`<div class="py-12 text-center text-red-500">Error: ${e.message}</div>`}}}async function We(){return setTimeout(()=>K(),100),`
        <div class="space-y-8 animate-on-scroll">
            <div>
    ...
    `}window.togglePortalSidebar=()=>{const s=document.getElementById("portal-sidebar"),e=document.getElementById("portal-sidebar-overlay");s&&e&&(s.classList.toggle("translate-x-0"),s.classList.toggle("-translate-x-full"),e.classList.toggle("hidden"))};window.toggleAyahAudio=()=>{const s=document.getElementById("ayah-audio"),e=document.getElementById("ayah-play-btn");!s||!e||(s.paused?(s.play(),e.innerHTML='<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"></path></svg>'):(s.pause(),e.innerHTML='<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"></path></svg>'),s.onended=()=>{e.innerHTML='<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"></path></svg>'})};const Je=s=>{const e=Array.isArray(s)?s:[];return e.includes("PuSMAG Admin")?"Admin":e.includes("PuSMAG Blogger")?"Blogger":e.includes("PuSMAG Member")?"Member":"User"};async function V(s){let e=s.section||"dashboard";s.name&&(e="member");const t=f.user;if(!t)return f.navigate("/login"),"";const o=Array.isArray(t&&t.roles)?t.roles:[],a=Je(o),r=o.includes("PuSMAG Admin"),n=o.includes("PuSMAG Blogger")||r,l=o.includes("PuSMAG Member")&&!n;let i={total_members:"...",active_programmes:"...",your_posts:"..."},d=null;const u=t&&t.email;if(e==="dashboard")try{if(u){const m=await Promise.allSettled([c.getPortalStats(),c.getVerseOfTheDay()]);m[0].status==="fulfilled"&&(i=m[0].value),m[1].status==="fulfilled"&&(d=m[1].value)}else try{d=await c.getVerseOfTheDay()}catch(m){console.error("Failed to fetch verse for guest:",m)}}catch(m){console.error("Failed to fetch dashboard data",m)}const h=!!(t&&t.member_name),p=[{id:"dashboard",label:"Dashboard",icon:"grid"},{id:"members",label:"Members",icon:"users",roles:["PuSMAG Member","PuSMAG Blogger","PuSMAG Admin"]},{id:"contact-requests",label:"Contact Requests",icon:"lock",roles:["PuSMAG Member","PuSMAG Blogger"],memberOnly:!0},{id:"blog",label:"Blog Posts",icon:"file-text",roles:["PuSMAG Blogger","PuSMAG Admin"]},{id:"registrations",label:"Registrations",icon:"user-plus",roles:["PuSMAG Admin"]},{id:"programmes",label:"Programmes",icon:"calendar",roles:["PuSMAG Admin"]},{id:"gallery",label:"Gallery",icon:"image",roles:["PuSMAG Admin"]}];p.find(m=>m.id===e)||p[0];const g=m=>`<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="${w(m)}"></path></svg>`,w=m=>{switch(m){case"grid":return"M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z";case"users":return"M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z";case"file-text":return"M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z";case"user-plus":return"M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z";case"calendar":return"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z";case"image":return"M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z";case"lock":return"M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z";default:return""}};let b="";switch(e){case"members":b=await Re();break;case"blog":b=await ze();break;case"registrations":b=await Ne();break;case"programmes":b=await Ve();break;case"gallery":b=await Oe();break;case"contact-requests":b=await We();break;case"member":b=await Ue(s);break;default:b=`
                <div class="space-y-8 animate-on-scroll">
                    <div class="flex items-center justify-between">
        ...
        <div class="min-h-screen pt-20 flex">
            ...
            <aside id="portal-sidebar" class="w-64 bg-neutral-900/95 md:bg-neutral-900/40 backdrop-blur-md border-r border-white/10 flex flex-col fixed inset-y-0 pt-20 z-40 -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out">
                ...
                <div class="p-6 flex-grow overflow-y-auto">
                    <nav class="space-y-1">
                        ${p.filter(m=>!(m.roles&&!m.roles.some(y=>t.roles.includes(y))||m.memberOnly&&!h)).map(m=>`
                            <a href="/portal/${m.id}" 
    ...
    `}function se(s){const e=i=>i==="/"?"/":`${L}${i}`,t=[{path:e("/"),label:"Home"},{label:"Who We Are",children:[{path:e("/about"),label:"About Us"},{path:e("/mission-vision"),label:"Mission & Vision"},{path:e("/guiding-principles"),label:"Guiding Principles"},{path:e("/objectives"),label:"Objectives"},{path:e("/governance"),label:"Governance"},{path:e("/ethics"),label:"Ethics"}]},{path:e("/programmes"),label:"Programmes"},{path:e("/blog-news"),label:"Blog/News"},{path:e("/gallery"),label:"Gallery"},{path:e("/contact"),label:"Contact"}],o=i=>s===i?"text-neutral-300":"text-neutral-400",a=i=>i.some(d=>d.path===s)?"text-neutral-300":"text-neutral-400",r=f.user,n=!!(r&&r.email),l=n&&Array.isArray(r.roles)&&(r.roles.includes("PuSMAG Member")||r.roles.includes("PuSMAG Admin"));return`
...
<div class="hidden md:flex items-center gap-6">
  ...
  `}function ae(){const s=e=>e==="/"?"/":`${L}${e}`;return`
  ...
  `}const Ye={"/":be,"/about":fe,"/mission-vision":we,"/guiding-principles":ye,"/objectives":ke,"/governance":Me,"/ethics":Le,"/programmes":Pe,"/programmes/:id":Ce,"/blog-news":_e,"/blog-news/:id":je,"/gallery":Ee,"/contact":Ie,"/forgot-password":De,"/update-password":Ge,"/register":Se,"/login":He,"/portal":V,"/portal/:section":V,"/portal/member/:name":V};class Qe{constructor(){this.currentPath=window.location.pathname,this.user=null}async init(){await this.handleRoute()}async navigate(e){let t=e;t!==window.location.pathname&&(window.history.pushState({},"",t),this.currentPath=t,await this.handleRoute())}async handleRoute(){let e=window.location.pathname;if(e.startsWith(L)&&(e=e.substring(L.length)),e.length>1&&e.endsWith("/")&&(e=e.slice(0,-1)),e.startsWith("/")||(e="/"+e),this.currentPath=e,!this.user&&!["/login","/register"].includes(e))try{const{api:n}=await Z(async()=>{const{api:l}=await Promise.resolve().then(()=>ee);return{api:l}},void 0);this.user=await n.getUserInfo()}catch{this.user=null}let t=null,o={};for(const[n,l]of Object.entries(Ye)){const i=this.matchRoute(n,e);if(i){t=l,o=i.params;break}}const a=!!(this.user&&this.user.email),r=a&&Array.isArray(this.user.roles)&&(this.user.roles.includes("PuSMAG Member")||this.user.roles.includes("PuSMAG Admin"));if(e.startsWith("/portal")){if(!a){console.log("Access denied. Redirecting to login."),this.navigate("/login");return}if(!r){console.log("Not authorized for portal. Redirecting home."),this.navigate("/");return}}t?this.render(t,o):(console.log("No route matched for:",e),this.render404()),window.scrollTo(0,0)}matchRoute(e,t){if(e==="/"&&t==="/")return{params:{}};if(e==="/"&&t!=="/")return null;const o=e.split("/").filter(Boolean),a=t.split("/").filter(Boolean);if(o.length!==a.length)return null;const r={};for(let n=0;n<o.length;n++)if(o[n].startsWith(":")){const l=o[n].slice(1);r[l]=a[n]}else if(o[n]!==a[n])return null;return{params:r}}async render(e,t={}){const o=document.getElementById("app");if(!document.getElementById("navbar")){o.innerHTML=`
              <div id="navbar"></div>
              <main id="main-content" class="min-h-screen"></main>
              <div id="footer"></div>
            `;const n=document.getElementById("footer");n.innerHTML=ae()}const a=document.getElementById("navbar");a.innerHTML=se(window.location.pathname);const r=document.getElementById("main-content");try{const n=await e(t);r.innerHTML=n}catch(n){console.error("Error rendering page:",n),r.innerHTML='<div class="pt-32 text-center text-red-500">Error loading content. Please try again.</div>'}setTimeout(()=>B(),100),this.updateNavbarActiveState()}updateNavbarActiveState(){const e=document.querySelectorAll("nav a"),t=window.location.pathname;e.forEach(o=>{o.getAttribute("href")===t?(o.classList.add("text-neutral-300"),o.classList.remove("text-neutral-400")):(o.classList.remove("text-neutral-300"),o.classList.add("text-neutral-400"))})}render404(){const e=document.getElementById("app");document.getElementById("navbar")||(e.innerHTML=`
                <div id="navbar"></div>
                <main id="main-content"></main>
                 <div id="footer"></div>
            `,document.getElementById("navbar").innerHTML=se(window.location.pathname),document.getElementById("footer").innerHTML=ae());const t=document.getElementById("main-content");t.innerHTML=`
          <div class="min-h-screen flex items-center justify-center pt-20">
            <div class="text-center">
              ...
              <a href="${L}/" class="btn-custom">
                <span class="inner">Go Home</span>
              </a>
            </div>
          </div>
        `}async logout(){try{const{api:e}=await Z(async()=>{const{api:t}=await Promise.resolve().then(()=>ee);return{api:t}},void 0);await e.logout()}catch(e){console.error("Logout error:",e)}finally{this.user=null,this.navigate("/login")}}}const f=new Qe;window.handleLogout=()=>f.logout();window.onerror=function(s,e,t,o,a){const r=`
